...
(
  ...
  'authenticated','authenticated','checkpoint-standard@test.local','',now(),
  '{"provider":"email","providers":["email"]}'::jsonb,'{}'::jsonb,now(),now()
),
(
  '00000000-0000-0000-0000-000000000000',
  'cc000000-0000-4000-8000-000000000002',
  'authenticated','authenticated','checkpoint-timed@test.local','',now(),
  '{"provider":"email","providers":["email"]}'::jsonb,'{}'::jsonb,now(),now()
);
...
INSERT INTO public.edge_exam_sync_inbox(
  ...
  'cc000000-0000-4000-8000-000000000001',
  'cc000000-0000-4000-9000-000000000101',
  26,
  'session.checkpoint',
  '{
    "session_id":"cc000000-0000-4000-9000-000000000101",
...
SELECT extensions.is(
  (SELECT version FROM public.edge_exam_sessions WHERE session_id='cc000000-0000-4000-9000-000000000101'),
  26::bigint,
  'checkpoint advances the slim edge session version'
);

SELECT extensions.is(
  (SELECT answered_question_ids FROM public.edge_exam_sessions WHERE session_id='cc000000-0000-4000-9000-000000000101'),
...
SELECT extensions.is(
  (SELECT answer_state FROM public.edge_user_question_state
   WHERE user_id='cc000000-0000-4000-8000-000000000001' AND question_id=700001),
  'correct',
...
SELECT extensions.is(
  (SELECT answer_state FROM public.edge_user_question_state
   WHERE user_id='cc000000-0000-4000-8000-000000000001' AND question_id=700002),
  'incorrect',
...
INSERT INTO public.edge_exam_sync_inbox(
  ...
  'checkpoint-timed-1',
  'cc000000-0000-4000-8000-000000000002',
  'cc000000-0000-4000-9000-000000000202',
  12,
  'session.checkpoint',
  '{
    "session_id":"cc000000-0000-4000-9000-000000000202",
    "session_type":"timed",
    "version":12,
    "answers":[
...
SELECT extensions.is(
  (SELECT count(*)::integer FROM public.edge_user_question_state
   WHERE user_id='cc000000-0000-4000-8000-000000000002' AND question_id=700003),
  0,
