-- ==============================================================================
-- ROYAL BANK - COMPLETE SUPABASE DATABASE SETUP SCRIPT (v2)
-- Copy and run this script inside Supabase Dashboard -> SQL Editor -> Run
-- ==============================================================================
...
-- Read-only for authenticated students, full CRUD for admin
...
-- Insert Initial Seed for Default Pathways & Question Banks
INSERT INTO public.pathways (id, name, slug, description, is_free_trial_available, display_order)
VALUES 
    (1, 'MRCP Part 1', 'mrcp-part-1', 'Royal College of Physicians Examination Part 1', true, 1),
    (2, 'MRCOG Part 1', 'mrcog-part-1', 'Royal College of Obstetricians and Gynaecologists', false, 2),
    (3, 'MRCS Part A', 'mrcs-part-a', 'Intercollegiate MRCS Part A Examination', false, 3),
    (4, 'PLAB 1 / UKMLA', 'plab-ukmla', 'GMC General Medical Council Licensing Exam', false, 4)
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.question_banks (id, pathway_id, name, description, display_order)
VALUES 
    (1, 1, 'MRCP Part 1 Main Bank', '5,400+ Verified Questions with full clinical explanations', 1)
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.blocks (id, name, question_bank_id, max_questions, is_free, display_order)
VALUES 
    (1, 'Free Trial Block', 1, 70, true, 1)
ON CONFLICT (id) DO NOTHING;
