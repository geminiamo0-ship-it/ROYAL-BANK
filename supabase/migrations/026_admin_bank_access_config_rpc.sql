-- Explicit admin operation for configuring which banks are free-trial banks.
...
BEGIN
    ...
    SET
        ...
        free_trial_block_limit = CASE
            WHEN p_is_free_trial THEN p_free_trial_block_limit
            ELSE NULL
        END
    WHERE id = p_bank_id
